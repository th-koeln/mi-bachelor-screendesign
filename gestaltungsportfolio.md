...
## Abgabe
Das Portfolio muss bis zum {{site.data.abgaben.artefakt0.date | date: '%d.%m.%Y'}} 23:55 Uhr im [{{site.data.abgaben.artefakt0.uebergabepunkt-text}}]({{site.data.abgaben.artefakt0.uebergabepunkt-link}}) hochgeladen sein.
