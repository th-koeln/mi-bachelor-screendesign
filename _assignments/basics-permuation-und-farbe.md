...
Im Ergebnis sollen fünf interessante Komposition entstehen. Fügen sie dieser bitte auch folgende Elemente hinzu:
- Headline  "Permutation"
- kurze Definition des Begriffs
- Ihren Namen

Exportieren Sie die Komposition als PNG (2x) und laden Sie diese im [ILU](https://ilu.th-koeln.de/ilias.php?baseClass=ilexercisehandlergui&cmdNode=cw:nq:4i&cmdClass=ilAssignmentPresentationGUI&ref_id=679320&ass_id=23821&mode=future&from_overview=1) hoch. Verwenden Sie beim Dateinamen bitte die folgende Nomenklatur:

> ```sd-permutation-NACHNAME-NUMMER.png```
