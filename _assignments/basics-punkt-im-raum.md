...
Legen Sie eine weiße Arbeitsfläche (Frame) mit einer Größe von **1440x900px** an. 
...
Erstellen Sie mindestens drei Kompositionen, die unterschiedliche Aspekte der Bewegung im Raum darstellen. Jede Komposition soll eine andere Art von Bewegung zeigen (z. B. eine kurvige Fahrt, eine sprunghafte Bewegung, ...). Fügen Sie jeder Komposition eine kurze Bezeichnung hinzu, um darzustellen, welche Art von Bewegung Sie veranschaulicht haben.
